...
export async function discoverPortalOutputs(root){
  const paths=new Set(['app/data/index.generated.json','evals/router.skill-eval.json','evidence/import-report.json','evidence/non-regression-harness.json','evidence/non-regression-report.json','evidence/scenarios/closure-plan.json','evidence/scenarios/index.json','provenance.yaml','sbom.npm.spdx.json','sbom.spdx.json']);
