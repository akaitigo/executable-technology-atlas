...
const componentPaths = ['scripts/check-non-regression.mjs','scripts/lib/non-regression.mjs','scripts/lib/neutral-language.mjs','scripts/lib/depth-reference.mjs','scripts/lib/authority-review.mjs','contracts/non-regression-baseline.json','contracts/non-regression-mappings.json','contracts/depth-reference-lock.json','contracts/authority-review-lock.json'];
