...
await add('contracts/non-regression-baseline.json','source','Apache-2.0',['portal-non-regression-policy']);await add('contracts/non-regression-mappings.json','source','Apache-2.0',['portal-non-regression-policy']);
