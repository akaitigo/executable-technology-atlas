...
const harnesses={'portal.import.integrity':'scripts/import-releases.mjs','portal.non-regression.baseline':'evidence/non-regression-harness.json','portal.ui.build':'app/page.tsx','portal.router.eval':'scripts/run-evals.mjs','portal.performance.budget':'scripts/performance-budget.mjs','portal.security.headers':'public/_headers','portal.publication.sbom':'scripts/generate-sbom.mjs'};
