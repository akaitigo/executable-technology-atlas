    ...
    <>
      ...
      <main id="top">
        ...
        <section className="certificate-section" id="portal-certificate" aria-labelledby="portal-certificate-title">
          <div><p className="eyebrow">Portal Completion Certificate</p><h2 id="portal-certificate-title">Subjectの完成数と、Portal自身の完成を混ぜない。</h2><p>Portal RepositoryはGitHub PUBLICのmainを正本とします。Portal v1のCompletion Certificateと、Subjectの公開Certificate完成{publicComplete}件は別軸で検証・表示します。</p></div>
