  ...
  return (
    <>
      ...
      <header className="site-header">
        ...
        <nav aria-label="主要ナビゲーション"><a href="#explorer">探索</a><a href="#authority-review">Human Review</a><a href="#evidence-dependency">Dependency Graph</a><a href="#verification">検証</a><a href="#portal-certificate">Portal証明</a><a href="#contract">契約</a></nav>
