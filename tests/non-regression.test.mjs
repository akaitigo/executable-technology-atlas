...
test('削除・格上げ・不可視化・粒度低下を拒否する', async () => {
  ...
  try {
    for (const directory of ['contracts','contracts/reference','app/data','evidence','fixtures/depth-references','fixtures/fixed-commit-audits','fixtures/portal-root-surface-inventory','public/data/releases','public/data/authority-reviews','public/data/fixed-commit-audits','public/data/index']) await mkdir(path.join(temporary,directory), { recursive:true });
    for (const file of ['mastery.yaml','coverage.yaml','contracts/non-regression-baseline.json','contracts/non-regression-mappings.json','contracts/depth-reference-lock.json','contracts/authority-review-lock.json','contracts/evidence-dependency-lock.json','contracts/definitive-v2-lock.json','contracts/portal-root-definitive-lock.json','contracts/portal-root-surface-inventory.json','contracts/fixed-commit-audit-lock.json','contracts/fixed-commit-audit-postgresql-lock.json','contracts/fixed-commit-audit-flutter-lock.json','contracts/fixed-commit-audit-rabbitmq-lock.json','contracts/fixed-commit-audit-kotlin-lock.json','contracts/fixed-commit-audit-zero-trust-lock.json','contracts/fixed-commit-audit-frontend-behavior-lock.json','contracts/reference/MIGRATION_DEFINITIVE_V2.md','app/data/index.generated.json','app/data/index-bootstrap.generated.json','app/lib/verified-json.mjs','evidence/import-report.json','evidence/portal-root-definitive-report.json','fixtures/failure-scenarios.json','fixtures/registry.json','fixtures/registry/invalid-registry-cases.json','fixtures/portal-root-surface-inventory/negative-cases.json','app/page.tsx']) {
