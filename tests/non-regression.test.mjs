...
test('削除・格上げ・不可視化・粒度低下を拒否する', async () => {
  ...
  try {
    for (const directory of ['contracts','contracts/reference','app/data','fixtures/depth-references','public/data/releases','public/data/authority-reviews']) await mkdir(path.join(temporary,directory), { recursive:true });
